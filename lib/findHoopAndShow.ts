module.exports = function (data: JSON) {
   ...
   */
  function jsonToMap(dataJson: JSON): Map<string, object> {
   ...
   */
  function typeConversion(dataMap: Map<string, object>): { directedGraph: Map<string, Array<string>>, indegree: Map<string, number>, noVisited: Set<string> } {
    ...
    function isValidKey(value: string, object: object): value is keyof typeof object {
   ...
   */
  function findHoopAndShow(directedGraph: Map<string, Array<string>>, indegree: Map<string, number>, noVisited: Set<string>) {
    // 获取入口节点
