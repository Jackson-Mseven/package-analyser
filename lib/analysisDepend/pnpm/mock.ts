...
export const getPnpmDependHashData = {
    params: [1000000000],
    return: [hash, devHash],
};

export const getPnpm6_0AllDependHash = {
    params: ['devDependencies', getPnpmYamlObj.return],
};

export const getPnpmAllDependHash = {
    params: ['dependencies'],
    return: hash,
};
